...
class Article extends amplify_core.Model {
  ...
  const Article._internal({required this.id, title, content, createdAt, updatedAt}): _title = title, _content = content, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Article({String? id, String? title, String? content}) {
