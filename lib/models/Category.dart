...
class Category extends amplify_core.Model {
  ...
  const Category._internal({required this.id, title, content, createdAt, updatedAt}): _title = title, _content = content, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Category({String? id, String? title, String? content}) {
  ...
  Category copyWith({String? title, String? content}) {
    return Category._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'content': _content, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
